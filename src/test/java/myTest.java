...
public class myTest {
    ...
    public void testGenerator() {
        ...
        globalConfig.setAuthor("smile")
                .setOutputDir("F:\\Projects\\family_platform\\src\\main\\java")//设置输出路径
        ...
        dataSourceConfig.setDriverName("com.mysql.cj.jdbc.Driver").setUrl("jdbc:mysql://localhost:3306/family_platform?serverTimezone=UTC")
        ...
        packageConfig.setParent("com.s").setMapper("mapper")
